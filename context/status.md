...
**Laatste update**: 2026-06-21 · **Versie**: 0.62.0 · **Branch**: `main`
...
- **Blok 3** — project ✅ (v0.62.0: AI-samenvatting gelabeld + laad-staat + dode-affordance-fix). Resterend:
  nieuws (lid/tool-match tónen), agenda (graaf-bewust + dode concierge-haak), ideeën (near-duplicate-hint),
  roadmap (idee-herkomst), auth (agent-aan-de-deur). Losse follow-up: Tailwind dev-CDN → vooraf-gebouwde CSS.
