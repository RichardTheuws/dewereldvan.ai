...
**Laatste update**: 2026-06-21 · **Versie**: 0.62.1 · **Branch**: `main`
...
- **Blok 3** — project ✅ (v0.62.0) · nieuws ✅ (v0.62.1: graaf-edge-treatment; persist-match bewust níét —
  YAGNI + false-positive-risico). Resterend: agenda (graaf-bewust + dode concierge-haak), ideeën
  (near-duplicate-hint), roadmap (idee-herkomst via bestaande linked_idea_id), auth (agent-aan-de-deur).
  Losse follow-up: Tailwind dev-CDN → vooraf-gebouwde CSS.
