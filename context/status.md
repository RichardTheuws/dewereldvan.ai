...
**Laatste update**: 2026-06-21 · **Versie**: 0.61.0 · **Branch**: `main`
...
- **Blok 3 (volgende)** — project, nieuws, agenda, ideeën, roadmap, auth (veelal "maak al-gebouwde intelligentie
  zichtbaar"). Losse follow-up: Tailwind dev-CDN → vooraf-gebouwde CSS (FOUC, alle publieke pagina's).
